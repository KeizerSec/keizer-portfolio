export const projects = [
  ...
  },
  {
    ...
    name: "NetAudit",
    icon: "🔍",
    description: "Scanner de vulnérabilités réseau avec corrélation MITRE ATT&CK — chaque CVE et service détecté est mappé à des techniques d'attaque concrètes, un chemin d'attaque kill chain est généré avec un niveau de risque global. API REST Flask, rapports HTML dark-mode, Docker.",
    tags: ["Python", "Flask", "MITRE ATT&CK", "Docker", "Nmap", "REST API"],
    lang: "Python",
    url: "https://github.com/KeizerSec/netaudit",
    features: [
      "Corrélation CVE/service → techniques ATT&CK",
      "Chemin d'attaque kill chain + risk level CRITICAL/HIGH/MEDIUM/LOW",
      "Rapport HTML dark-mode avec visualisation kill chain",
      "API REST + auth API key + rate limiting + cache LRU",
    ],
  },
  {
    id: 4,
