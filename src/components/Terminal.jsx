...
const COMMANDS = {
  ...
  about: [
    ...
    "181 rooms | 28 badges | 1000h+ de pratique", "",
  ...
  projects: [
    ...
    "3. NetAudit",
    "   Scanner réseau — CVSS + KEV + EPSS, ATT&CK, Docker, 341 tests",
    "   > github.com/KeizerSec/netaudit", "",
    ...
    "   > github.com/KeizerSec/keizer-portfolio", "",
    "7. Tryhackme-Badge",
    "   GitHub Action — badge SVG live des stats THM (5 thèmes)",
    "   > github.com/KeizerSec/Tryhackme-Badge",
  ],
  litm: [
